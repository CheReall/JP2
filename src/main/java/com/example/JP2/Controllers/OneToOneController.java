...
import com.example.JP2.Repo.AdressRepository;
...
public class OneToOneController
{
    ...
    public String universityAdd(Model model){
        ...
        return "other/university-add";
    }
    @PostMapping("/university/add")
    public String universityPAdd(@RequestParam String adres, @RequestParam String named, Model model)
    {
        Adress adress = adressRepository.findByAdres(adres);
        University university = new University(named,adress);
